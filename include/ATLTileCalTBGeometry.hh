...
{
constexpr double XMin() { return 2000; }
constexpr double XMax() { return 2200; }
...
struct Cell
{
  ...
  constexpr Cell(Module module_, Row row_, int nCell_, std::size_t firstRow_, std::size_t lastRow_,
    std::size_t nTilesRow0, std::size_t nTilesRow1, std::size_t nTilesRow2, std::size_t nTilesRow3,
